...
<dl>
  ...
  <dd>{t site=$site_name escape=no}The web address for a picture to represent you on %1. It should not be more than 80x80 pixels. (64x64 is best.) If you leave this empty, we'll use <a href='http://libravatar.org'>Libravatar.org</a> to find an image for you.{/t}</dd>
  ...
  <dd>{t escape=no}The address for your profile on the social web on an ActivityPub-powered site such as <a href='http://social.lol/' target='_blank'>social.lol</a>.{/t}</dd>
