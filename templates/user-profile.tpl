...
{if !($isme)}<div class="alert alert-info"><h2>What did {$me->name} listen to in 2024?</h2><p class="lead"><a href="/user/{$me->name}/recap/2024">See {$me->name}'s 2024 recap</a></p></div>{/if}
