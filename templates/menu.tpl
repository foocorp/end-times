...
{if ($logged_in)}
<li class="nav-item"><a class="edit-profile-link" href="/user/{$this_user->name}"><img src="{$this_user->getAvatar(24)}" width="24" height="24" alt loading="lazy">&nbsp;{$this_user->name}</a></li>
