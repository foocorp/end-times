...
{if ($logged_in)}
<li class="nav-item"><img src="{$this_user->getAvatar(24)}" width="24" height="24" alt loading="lazy"> <a class="edit-profile-link" href="/user/{$this_user->name}">{$this_user->name}</a></li>
