...
<li class="nav-item"><a href="/user/{$this_user->name}/recap/2024" title="Your 2024 recap">2024</a>{if ($this_user_first_year}}{if ($this_user_first_year < 2024)}&mdash;<a href="/user/{$this_user->name}/recap/{$this_user_first_year}" title="Your first year of data recapped!">{$this_user_first_year}</a>{/if}{/if}</li>
