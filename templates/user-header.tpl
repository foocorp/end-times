...
<p><img class="u-photo" style="background: #666 url(https://turtle.libre.fm/spinner.gif); background-position: center center; background-repeat: no-repeat; " loading="lazy" height="90" width="90" border="1" src="{$me->getAvatar(90)}" alt=""></p>
