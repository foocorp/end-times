...
{section name=i loop=$extra_head_links}
	...
	<li><a href="https://shareopenly.org/share/?url=https://libre.fm/user/{$me->name}/scrobble/{$scrobble}&text={$me->name} {if $me->laconica_profile}({$me->laconica_profile}){/if} listened to {$track} {if $artist}by {$artist}{/if}{if $album} on {$album}{/if}%0A%0A %23librefm %23indieweb %23music %23shareopenly">Share this on social media</a></li>
{/section}
</ul>
