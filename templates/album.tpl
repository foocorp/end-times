...
{if $album->mbid}<p><small>Cover Art provided by <a href="https://coverartartchive.org/">Cover Art Archive</a>, a project of MusicBrainz and the Internet Archive.</small></p>{/if}
